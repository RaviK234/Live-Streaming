...
/* harmony import */ var _streamn_io_streamn_io_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./streamn-io/streamn-io.component */ "./src/app/modules/live-streaming/streamn-io/streamn-io.component.ts");
/* harmony import */ var _live_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./live-routing.module */ "./src/app/modules/live-streaming/live-routing.module.ts");
...
LiveStreamingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _live_routing_module__WEBPACK_IMPORTED_MODULE_5__["LiveRoutingModule"],
...
let StreamnIOComponent = class StreamnIOComponent {
    constructor(socket, request, utility) {
        this.socket = socket;
...
StreamnIOComponent.ctorParameters = () => [
...
let RequestService = class RequestService {
    ...
    getYoutubeDetails(body) {
        return this._http.post(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/v1/broadcast`, body);
    }
    searchByKeyword(keyword, userId) {
        return this._http.get(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/v1/search/${userId}/${keyword}`);
    }
};
